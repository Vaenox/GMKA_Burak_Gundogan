...
def word2vec_create(value):
    model = Word2Vec(sentences = list(value),vector_size=100,window=5,min_count=1)
...
if __name__ == '__main__':
    ...
    df_2=df_2.drop(df_2.loc[97:97].index)
    ...
    model.build_vocab(df_2["Text_2"].to_list(),update=True) 
    ...
    print("Accuracy Skor:",accuracy_score(y_test,y_pred))
